...
export const zhTW = {
  ...
  "analysis.auto": "自動",
  "solution.show": "正確做法",
  "solution.windowTitle": "正確做法",
  "solution.close": "關閉",
  "solution.collapse": "收起",
  "solution.generating": "產生建議中…",
  "solution.suggestedLine": "你可以這樣說",
  "solution.why": "為什麼",
  "solution.retry": "重試",
  "solution.failed": "（產生失敗：{error}）",
  "solution.empty": "目前沒有可建議的做法。",
  "solution.noKey": "設定 AI 金鑰後可查看建議做法。",
...
export const en = {
  ...
  "analysis.auto": "Auto",
  "solution.show": "How to handle it",
  "solution.windowTitle": "How to handle it",
  "solution.close": "Close",
  "solution.collapse": "Collapse",
  "solution.generating": "Generating advice…",
  "solution.suggestedLine": "What to say instead",
  "solution.why": "Why",
  "solution.retry": "Retry",
  "solution.failed": "(Failed: {error})",
  "solution.empty": "No suggestion available.",
  "solution.noKey": "Set an AI key to see how to handle it.",
