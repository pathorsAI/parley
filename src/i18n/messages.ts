...
export const zhTW = {
  ...
  "replay.upload": "上傳錄音",
  "ingest.title": "分析錄音",
  "ingest.countIntro": "先選擇這段錄音大約有幾位說話者（之後仍可調整）。按開始後會依序：轉錄 → 依聲音分人 → 讓你確認說話者 → 分析。",
  "ingest.start": "開始",
...
export const en = {
  ...
  "ingest.countIntro": "Pick roughly how many speakers this recording has (you can adjust later). After Start it runs: transcribe → diarize by voice → review speakers → analyze.",
  "ingest.start": "Start",
