...
export const zhTW = {
  ...
  "speakers.voiceIntro": "直接分析音訊的聲音特徵，把每一句歸到不同說話者——不靠語音辨識的分人，也不靠 AI 猜內容，因此沒有分人功能的 STT 也適用。第一次使用會下載約 27MB 的聲紋模型。",
  "speakers.voiceCount": "說話者人數",
  "speakers.voiceAuto": "自動",
  "speakers.voiceRun": "開始辨識",
  "speakers.voiceRunning": "辨識聲音中…",
  "speakers.voiceDownloading": "下載聲紋模型… {percent}%",
  "speakers.voiceResult": "依聲音分出 {speakers} 位說話者（共 {total} 句），可在上方重新命名。",
...
export const en = {
  ...
  "speakers.voiceIntro": "Analyzes the audio's voice characteristics to group every line by speaker — no reliance on the STT's diarization or on AI guessing from the words, so it works even for STT with no diarization. First use downloads a ~27MB voice model.",
  "speakers.voiceCount": "Number of speakers",
  "speakers.voiceAuto": "Auto",
  "speakers.voiceRun": "Diarize",
  "speakers.voiceRunning": "Analyzing voices…",
  "speakers.voiceDownloading": "Downloading voice model… {percent}%",
  "speakers.voiceResult": "Grouped into {speakers} speakers by voice ({total} lines). Rename them above.",
